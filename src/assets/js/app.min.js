...
$(document).ready(function() {
    ...
    $(".form-group--float")[0] && ($(".form-group--float").each(function() {
        ...
        0 == !a.length && $(this).find(".form-control").addClass("form-control--active")
    }), 
    $("body").on("blur", ".form-group--float .form-control", function() {
        var a = $(this).val();
        0 == a.length ? $(this).removeClass("form-control--active") : $(this).addClass("form-control--active")
    }))
  }),

$("#dropzone-upload")[0] && (Dropzone.autoDiscover = !1), $(document).ready(function() {
    if ($(".btn")[0] && (Waves.init(), Waves.attach(".btn")), $("#data-table")[0]) {
        var a = '<div class="dataTables_buttons hidden-sm-down actions"><span class="actions__item zmdi zmdi-print" data-table-action="print" /><span class="actions__item zmdi zmdi-fullscreen" data-table-action="fullscreen" /><div class="dropdown actions__item"><i data-toggle="dropdown" class="zmdi zmdi-download" /><ul class="dropdown-menu dropdown-menu-right"><a href="" class="dropdown-item" data-table-action="excel">Excel (.xlsx)</a><a href="" class="dropdown-item" data-table-action="csv">CSV (.csv)</a></ul></div></div>';
        ...
        $("#data-table").DataTable({
            ...
            lengthMenu: [
                [10, 20, 30, -1],
                ["10 Linhas", "20 Linhas", "30 Linhas", "Tudo"]
            ],
            language: {
            ...
            initComplete: function() {
                $(this).closest(".dataTables_wrapper").prepend(a)
            }
    ...
    if ($(".textarea-autosize")[0] && autosize($(".textarea-autosize")), $("input-mask")[0] && $(".input-mask").mask(), $("select.select2")[0]) {
        var b = $($(".select2-parent")[0] ? ".select2-parent" : "body");
    ...
    if ($("#dropzone-upload")[0] && $("#dropzone-upload").dropzone({
        ...
        $("#input-slider")[0]) {
        var c = document.getElementById("input-slider");
        noUiSlider.create(c, {
            start: [20],
            connect: "lower",
            range: {
    ...
    if ($("#input-slider-range")[0]) {
        var d = document.getElementById("input-slider-range"),
            e = document.getElementById("input-slider-range-value-1"),
            f = document.getElementById("input-slider-range-value-2"),
            g = [e, f];
        noUiSlider.create(d, {
            start: [20, 80],
            connect: !0,
    ...
    if ($(".input-slider")[0])
        for (var h = document.getElementsByClassName("input-slider"), i = 0; i < h.length; i++) noUiSlider.create(h[i], {
            start: [20],
            connect: "lower",
            range: {
                min: 0,
    ...
    if ($(".color-picker")[0] && ($(this).each(function() {
        ...
        var j = moment().format("YYYY"),
            k = moment().format("dddd, MMM D");
        $(".widget-calendar__year").html(j), $(".widget-calendar__day").html(k)
    }
    if ($(".notes__body")[0]) {
        var l;
        $(".notes__body").each(function(a, b) {
            l = $(this).prev().is(".notes__title") ? 4 : 6, $clamp(b, {
                clamp: l
            })
        })
    }
...
$(document).ready(function() {
    ...
    var b = $("body");
    b.on("click", "[data-ma-action]", function(b) {
        b.preventDefault();
        var c = $(this),
            d = c.data("ma-action"),
            e = "";
        switch (d) {
            ...
            case "search-close":
                ...
                break;
            case "aside-open":
                if($(c.data("ma-target")).hasClass('toggled')){
